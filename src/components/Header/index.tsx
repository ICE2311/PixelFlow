      ...
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        ...
        >
          ...
          <div className="mt-7 flex items-center gap-6 xl:mt-0">
            ...
            <Link
              href="/signin"
              className="flex items-center justify-center rounded-full bg-primary px-7.5 py-2.5 text-regular dark:text-black text-white duration-300 ease-in-out hover:bg-primaryho"
            >
              Get Pro 🔥
            </Link>
          </div>
