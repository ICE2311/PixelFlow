...
export default {
	darkMode: ["class"], // Merged darkMode setting
	content: [
		...
		"./app/**/*.{js,ts,jsx,tsx,mdx}", // Retained original content paths from both configs
		"./pages/**/*.{js,ts,jsx,tsx,mdx}",
	],
	theme: {
		extend: {
			fontFamily: {
				...
				sans: [
					'var(--font-geist-sans)', // Added sans from the second config
					...fontFamily.sans, // Preserved the default sans from tailwind
				]
			},
			borderRadius: {
				lg: 'var(--radius)', // Added borderRadius from the second config
	...
	plugins: [require("tailwindcss-animate")], // Plugin from the second config
} satisfies Config;
